...
func Router(dbRepo repository.DataBaseRepository, cacheRepo repository.CacheRepository, smtpRepo repository.SmtpClientRepository) *mux.Router {
	...
	adminRouter.HandleFunc("/delete/plc/{plcId}", adminHandler.DeletePlcHandler).Methods("GET")
	...
	adminRouter.HandleFunc("/delete/drier/{plcId}/{drierId}", adminHandler.DeleteDrierHandler).Methods("GET")
	...
	adminRouter.HandleFunc("/delete/register/{plcId}/{drierId}/{regAddress}/{regTypeName}", adminHandler.DeleteRegisterHandler).Methods("GET")
	adminRouter.HandleFunc("/create/register_type", adminHandler.CreateRegisterTypeHandler).Methods("POST")
	adminRouter.HandleFunc("/delete/register_type/{regTypeName}", adminHandler.DeleteRegTypeHandler).Methods("GET")
